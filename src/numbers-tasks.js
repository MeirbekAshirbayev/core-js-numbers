...
function getRectangleArea(width, height) {
  if (width < 0 || height < 0) {
    throw new Error('width and height must be a non-negative number');
  }
...
function numberToStringInBase(number, base) {
  if (
    ...
    throw new Error(
      'Invalid input. Please provide valid numbers and a base between 2 and 36.'
    );
  }
...
function toExponential(number, fractionDigits) {
  if (
    ...
    throw new Error(
      'Invalid input. Please provide a valid number and non-negative fractionDigits.'
    );
  }
...
function toPrecision(number, precision) {
  if (
    ...
    throw new Error(
      'Invalid input. Please provide a valid number and precision greater than or equal to 1.'
    );
  }
...
function getNumberValue(number) {
  if (!(number instanceof Number) && typeof number !== 'number') {
    throw new Error(
      'Invalid input. Please provide a valid Number object or a number.'
    );
  }
